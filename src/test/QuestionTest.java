...
public class QuestionTest {
    ...
    public void testConstructorWithJustification() {
        ...
        answers.add(new Answer("El polimorfismo en Java se refiere a la capacidad de un objeto para tomar diferentes formas y comportarse de diferentes maneras en función del contexto en el que se utiliza.", true, "Java"));
        answers.add(new Answer("El polimorfismo en Java se refiere únicamente a la capacidad de una clase para heredar propiedades y comportamientos de otra clase.", false, "Java"));
        ...
        // Act
        Question question = new Question(statement, answers, justification);
