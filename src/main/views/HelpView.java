...
public class HelpView extends JFrame {
    ...
    public HelpView(HomeController controller) {
        ...
        Font answerFont = new Font("Arial", Font.PLAIN, 16); // Fuente y tamaño del texto para las respuestas

        Color blueColor = new Color(0, 0, 255); // Color azul para las preguntas
